...
# Shape
old_rows, old_cols, old_channels = old_frame_resized.shape
# Region of Interest
old_roi = old_frame_resized[246:old_rows, :]
...
while True:
    ...
    # Shape
    new_rows, new_cols, new_channels = new_frame_resized.shape
    # Region of Interest
    new_roi = new_frame_resized[246:new_rows, :]
    # Grayscale
